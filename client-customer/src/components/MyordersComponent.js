  ...
  renderOrders() {
    return this.state.orders.map((item) => (
      ...
      >
        ...
        <td className="px-6 py-4 text-lg text-gray-900 dark:text-white">${item.total}</td>
        <td className="px-6 py-4 text-lg text-gray-900 dark:text-white">{item.status}</td>
      </tr>
    ));
  }
  ...
  render() {
    ...
    return (
      <div className="relative overflow-x-auto pt-8 dark:bg-gray-900">
          ...
          <h2 className="text-2xl font-bold pb-4 text-center dark:text-white">Order List</h2>
    

        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <thead>
            <tr className="bg-gray-200">
              <th className="px-6 py-3 text-lg text-gray-900 dark:bg-gray-900 dark:text-white text-center">ID</th>
              <th className="px-6 py-3 text-lg text-gray-900 dark:bg-gray-900 dark:text-white text-center">Date</th>
              <th className="px-6 py-3 text-lg text-gray-900 dark:bg-gray-900 dark:text-white text-center">Name</th>
              <th className="px-6 py-3 text-lg text-gray-900 dark:bg-gray-900 dark:text-white text-center">Phone</th>
              <th className="px-6 py-3 text-lg text-gray-900 dark:bg-gray-900 dark:text-white text-center">Total</th>
              <th className="px-6 py-3 text-lg text-gray-900 dark:bg-gray-900 dark:text-white text-center">Status</th>
            </tr>
          </thead>
        ...
        {this.state.order && (
          <div className="mt-8">
            ...
            <table className="w-full border-collapse border">
              <thead>
                <tr className="bg-gray-200">
                  <th className="px-6 py-3 text-lg text-gray-900 dark:bg-gray-900 dark:text-white">No.</th>
                  <th className="px-6 py-3 text-lg text-gray-900 dark:bg-gray-900 dark:text-white">Product ID</th>
                  <th className="px-6 py-3 text-lg text-gray-900 dark:bg-gray-900 dark:text-white">Product Name</th>
                  <th className="px-6 py-3 text-lg text-gray-900 dark:bg-gray-900 dark:text-white">Image</th>
                  <th className="px-6 py-3 text-lg text-gray-900 dark:bg-gray-900 dark:text-white">Price</th>
                  <th className="px-6 py-3 text-lg text-gray-900 dark:bg-gray-900 dark:text-white">Quantity</th>
                  <th className="px-6 py-3 text-lg text-gray-900 dark:bg-gray-900 dark:text-white">Amount</th>
                </tr>
              </thead>
